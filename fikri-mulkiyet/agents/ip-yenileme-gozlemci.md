...
description: >
  ...
  channel named in `~/.claude/plugins/config/hukuki-yetenek-seti/fikri-mulkiyet/CLAUDE.md`
...
1. Read `~/.claude/plugins/config/hukuki-yetenek-seti/fikri-mulkiyet/CLAUDE.md` to
...
Her son teslim tarihini TÜRKPATENT kayıtları ve (uluslararası işaretlerde)
WIPO Madrid Monitor ile doğrulayın; tescil öncesi/ödeme öncesi ilgili sicil
...
- Modify the register. It reads and reports; additions come from
  `/fikri-mulkiyet:portfoy-takip --add`, updates come from `--update`, sync comes
