...
1. **Follow the workflow below** and read
   `~/.claude/plugins/config/hukuki-yetenek-seti/fikri-mulkiyet/portfolio.yaml`.
...
```
/fikri-mulkiyet:portfoy-takip
```

```
/fikri-mulkiyet:portfoy-takip --report --days 180
```

```
/fikri-mulkiyet:portfoy-takip --add
```

```
/fikri-mulkiyet:portfoy-takip --update
```

```
/fikri-mulkiyet:portfoy-takip --audit
```
...
Lives at `~/.claude/plugins/config/hukuki-yetenek-seti/fikri-mulkiyet/portfolio.yaml`.
Structure:
...
Run /fikri-mulkiyet:portfoy-takip --report to see what's due.
```
...
```
/fikri-mulkiyet:portfoy-takip --report [--days 30|60|90|180]
```
...
Output (prepend work-product header per `~/.claude/plugins/config/hukuki-yetenek-seti/fikri-mulkiyet/CLAUDE.md` → Outputs):
...
`## Who's using this` in `~/.claude/plugins/config/hukuki-yetenek-seti/fikri-mulkiyet/CLAUDE.md`. If the Role is **Non-lawyer**:
