...
The user typed `/sirketler-hukuku:ozellestir`. They want to change something
...
1. **Read the config.** Read
   ...
   > You haven't run setup yet. Run `/sirketler-hukuku:kurulum-mulakati`
...
6. **Close.**
   ...
   > run `/sirketler-hukuku:ozellestir` anytime.
