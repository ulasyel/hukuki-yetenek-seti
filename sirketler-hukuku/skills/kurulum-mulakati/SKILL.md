...
description: >
  Türk şirketler hukuku için sirketler-hukuku başlangıç mülakatı. Şirket profili,
...
Bu skill, `sirketler-hukuku` plugin'ini Türk şirketler hukuku ve Türkiye uygulamasına göre yapılandırır. Orijinal ABD modülleri şu karşılıklara çevrilir:
...
- Config: `~/.claude/plugins/config/hukuki-yetenek-seti/sirketler-hukuku/CLAUDE.md`
- Ortak şirket profili: `~/.claude/plugins/config/hukuki-yetenek-seti/company-profile.md`
- Yeni işlem bağlamı: `~/.claude/plugins/config/hukuki-yetenek-seti/sirketler-hukuku/deals/[code]/deal-context.md`
...
> `sirketler-hukuku`, Türk şirketler hukuku iş akışları için profil kurar: M&A, yönetim kurulu/genel kurul, halka açık şirket uyumu ve tüzel kişi kayıt takibi.  
...
`~/.claude/plugins/config/hukuki-yetenek-seti/sirketler-hukuku/deals/[code]/deal-context.md`
...
- Aktif M&A varsa: `/sirketler-hukuku:kapanis-checklist` veya `/sirketler-hukuku:durum-tespiti-bulgu-cikarimi`
- Aktif governance varsa: `/sirketler-hukuku:toplantisz-karar`
- Aktif entities varsa: `/sirketler-hukuku:kurumsal-kayit-takip --init`
