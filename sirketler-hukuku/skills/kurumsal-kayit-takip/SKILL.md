...
`~/.claude/plugins/config/hukuki-yetenek-seti/sirketler-hukuku/entities/compliance-tracker.yaml`
...
Sonraki adım: /sirketler-hukuku:kurumsal-kayit-takip --report
```
