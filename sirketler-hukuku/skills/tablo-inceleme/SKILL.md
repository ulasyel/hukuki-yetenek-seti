...
1. Load `~/.claude/plugins/config/hukuki-yetenek-seti/sirketler-hukuku/CLAUDE.md` → diligence structure, thresholds, house format.
...
/sirketler-hukuku:tablo-inceleme --schema .review-schema.yaml --docs ./vdr/02-Contracts/
...
- `~/.claude/plugins/config/hukuki-yetenek-seti/sirketler-hukuku/CLAUDE.md` → diligence structure, materiality thresholds, house format preferences
- `~/.claude/plugins/config/hukuki-yetenek-seti/sirketler-hukuku/deals/[code]/deal-context.md` if working a specific deal
