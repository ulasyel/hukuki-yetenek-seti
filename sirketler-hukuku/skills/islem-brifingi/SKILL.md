...
- `~/.claude/plugins/config/hukuki-yetenek-seti/sirketler-hukuku/CLAUDE.md` → Deal team briefing (cadence, format, what the business reads)
- `~/.claude/plugins/config/hukuki-yetenek-seti/sirketler-hukuku/deals/[code]/deal-context.md` → deal lead, timeline
- Current findings from diligence-issue-extraction output

## Audience tiers

Per `~/.claude/plugins/config/hukuki-yetenek-seti/sirketler-hukuku/CLAUDE.md` — what the business reads vs. what's for the file. Default tiers:
...
If this is a recurring brief (per `~/.claude/plugins/config/hukuki-yetenek-seti/sirketler-hukuku/CLAUDE.md` cadence), lead with what changed:
