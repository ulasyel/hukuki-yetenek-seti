...
1. `~/.claude/plugins/config/hukuki-yetenek-seti/sirketler-hukuku/CLAUDE.md` dosyasını oku.
2. Varsa `~/.claude/plugins/config/hukuki-yetenek-seti/sirketler-hukuku/deals/[code]/deal-context.md` dosyasını oku.
3. Checklist dosyası varsa oku:
   `~/.claude/plugins/config/hukuki-yetenek-seti/sirketler-hukuku/deals/[code]/closing-checklist.yaml`
...
```text
/sirketler-hukuku:kapanis-checklist
