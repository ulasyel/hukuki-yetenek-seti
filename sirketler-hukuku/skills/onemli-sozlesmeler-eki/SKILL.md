...
- `~/.claude/plugins/config/hukuki-yetenek-seti/sirketler-hukuku/CLAUDE.md` → önemlilik eşikleri (sözleşme tanımından farklı olabilir — daima sözleşmedeki tanımı kullan)
