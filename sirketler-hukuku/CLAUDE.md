...
User-specific configuration for this plugin lives at:
  ...
  ~/.claude/plugins/config/hukuki-yetenek-seti/sirketler-hukuku/CLAUDE.md

Rules for every skill, command, and agent in this plugin:
1. READ configuration from that path. Not from this template.
2. If that file does not exist or still contains [PLACEHOLDER] markers, STOP before substantive work and ask the user to run `/sirketler-hukuku:kurulum-mulakati`.
...
Shared company-level facts live one level above this profile at:
  ...
  ~/.claude/plugins/config/hukuki-yetenek-seti/company-profile.md
-->
...
*`[PLACEHOLDER]` görüyorsanız `/sirketler-hukuku:kurulum-mulakati` çalıştırın.*
...
**Tracker dosyası:** `~/.claude/plugins/config/hukuki-yetenek-seti/sirketler-hukuku/entities/compliance-tracker.yaml`
...
*Tam kurulum için: `/sirketler-hukuku:kurulum-mulakati --redo`*
*Modül eklemek için: `/sirketler-hukuku:kurulum-mulakati --module [ma | governance | public | entities]`*
*Yeni işlem için: `/sirketler-hukuku:kurulum-mulakati --new-deal`*
