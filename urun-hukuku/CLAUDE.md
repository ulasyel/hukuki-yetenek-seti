...
KVKK iceren her lansmanda `/kvkk-uyum:kullanim-triyaji` onerilir. AI, otomatik karar, model egitimi, sentetik icerik veya AI vendor varsa `/yz-yonetisim:kullanim-triyaji` ve gerekirse vendor incelemesi tetiklenir. Guvenlik ve tedarikci riskleri hukuk degerlendirmesine yazilir ama teknik onay varsayilmaz.
