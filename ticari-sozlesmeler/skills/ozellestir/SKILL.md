...
1. **Read config.** Load:
   ...
   > Henüz kurulum yapılmamış. Önce `/ticari-sozlesmeler:kurulum-mulakati` komutunu çalıştırın; `customize` mevcut profili ayarlamak içindir.
...
2. **Show customizable map.** List current values in groups:
   ...
   - Playbook positions: liability caps, indemnity, cezai şart (TBK m.179-182), IP, data protection, termination, renewal, bakiye hükümler, residuals/hafızada kalan bilgi, damga vergisi, price escalation.
...
- KVKK, yurt dışına aktarım, KEP, e-imza, arabuluculuk/6325, TTK m.18/3 notice methods, damga vergisi (DVK/488), TBK m.179-182 cezai şart posture, and Turkish court/tahkim preferences are first-class profile fields.
