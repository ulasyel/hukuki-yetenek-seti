...
1. Load `~/.claude/plugins/config/hukuki-yetenek-seti/ticari-sozlesmeler/CLAUDE.md` -> `## Escalation`.
...
automatic_triggers:
  - uncapped liability
  - cezai şart above playbook / TBK m.179-182 risk
  - IP assignment
  - KVKK transfer risk
```
