...
| Komut | İşlev |
|---|---|
| `/ticari-sozlesmeler:kurulum-mulakati` | Türk commercial profile kurulumunu yapar veya günceller |
| `/ticari-sozlesmeler:inceleme [file]` | Sözleşme türünü tanır ve doğru inceleme skill'ine yönlendirir |
...
Bu klasör Türk adaptasyonunun `ticari-sozlesmeler` çalışma alanıdır. Ayrıntılı durum için `TURKISH_AUDIT.md` dosyasına bakın.
