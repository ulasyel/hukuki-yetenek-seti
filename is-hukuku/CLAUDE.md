...
Bu profil, `is-hukuku` skill'lerinin Türk iş hukuku ve uygulamasına göre çalışması için varsayılan çerçevedir. Kullanıcıya özel kurulumda `~/.claude/plugins/config/hukuki-yetenek-seti/is-hukuku/CLAUDE.md` yoluna yazılır.
...
**Matters path:** `~/.claude/plugins/config/hukuki-yetenek-seti/is-hukuku/matters/`
