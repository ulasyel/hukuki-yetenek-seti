---
name: sorusturma-belge-ekle
description: >
  Açık iç soruşturma dosyasına belge, görüşme notu, delil, kronoloji olayı veya
  gözlem ekler. Olgu/kanaat ayrımı, kaynak etiketi, KVKK minimizasyonu ve tarih
  kaydını zorunlu tutar.
argument-hint: "[slug] [belge/not/açıklama]"
---

# /sorusturma-belge-ekle
