...
1. `~/.claude/plugins/config/hukuki-yetenek-seti/is-hukuku/CLAUDE.md` dosyasını oku.
2. Profil yoksa veya placeholder ağırlıklıysa `/is-hukuku:kurulum-mulakati` öner.
