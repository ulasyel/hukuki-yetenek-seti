...
`~/.claude/plugins/config/hukuki-yetenek-seti/is-hukuku/CLAUDE.md` dosyasını Türk iş hukuku uygulamasına göre oluşturur veya günceller.
...
> `is-hukuku` Türkiye iş hukuku işleri içindir: işe alım, iş sözleşmesi, ücret ve çalışma süresi, izin/rapor, fesih, arabuluculuk, iç soruşturma, işyeri politikası, SGK/İŞKUR/İSG ve çalışan verisi.
>
...
Template olarak plugin içindeki `is-hukuku/CLAUDE.md` kullanılır.
