...
# /dosya-acilis (Uyuşmazlık Kaydı)

1. `~/.claude/plugins/config/hukuki-yetenek-seti/dava-yonetimi/CLAUDE.md` dosyasını yükle → risk kalibrasyonu (triyaj için), harita (bağlam, çatışma yöntemi için), paydaşlar (kimin dâhil edileceği için).
...
5. `~/.claude/plugins/config/hukuki-yetenek-seti/dava-yonetimi/matters/[kisa-ad]/matter.md` dosyasını oluşturun — tam anlatısal kayıt.
6. `~/.claude/plugins/config/hukuki-yetenek-seti/dava-yonetimi/matters/[kisa-ad]/history.md` dosyasını oluşturun — kayıt anını ilk girdi (entry zero) olarak ekleyin.
7. `~/.claude/plugins/config/hukuki-yetenek-seti/dava-yonetimi/matters/_log.yaml` dosyasına yapılandırılmış bir satır ekleyin.
...
- `~/.claude/plugins/config/hukuki-yetenek-seti/dava-yonetimi/CLAUDE.md` — risk kalibrasyonu (triyaj eşikleri, önemlilik, sulh merdiveni), harita (paydaşlar, dış hukuk bürosu yedeği).
- `~/.claude/plugins/config/hukuki-yetenek-seti/dava-yonetimi/matters/_log.yaml` — kısa adın benzersizliğini teyit etmek için.
...
Daha ileri gitmeden önce, `~/.claude/plugins/config/hukuki-yetenek-seti/dava-yonetimi/CLAUDE.md` → Menfaat Çatışması Kontrolü adımını çalıştırın.
...
- Eğer hayır ise ve bu aktif bir uyuşmazlıksa: acil olarak işaretleyin; kayıt bittikten sonra `/dava-yonetimi:delil-muhafaza [kisa-ad] --issue` çalıştırmayı teklif edin.
...
### `~/.claude/plugins/config/hukuki-yetenek-seti/dava-yonetimi/matters/[kisa-ad]/matter.md`
...
### `~/.claude/plugins/config/hukuki-yetenek-seti/dava-yonetimi/matters/[kisa-ad]/history.md`
...
### `~/.claude/plugins/config/hukuki-yetenek-seti/dava-yonetimi/matters/_log.yaml` Dosyasına Ekleme
