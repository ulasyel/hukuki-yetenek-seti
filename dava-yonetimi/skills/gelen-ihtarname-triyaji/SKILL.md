...
2. Load `~/.claude/plugins/config/hukuki-yetenek-seti/dava-yonetimi/matters/_log.yaml` if available for portfolio check.
3. Load `dava-yonetimi/CLAUDE.md` for risk calibration and style.
4. Extract data, deadlines, allegations, legal bases, and requested action.
5. Save analysis to `~/.claude/plugins/config/hukuki-yetenek-seti/dava-yonetimi/inbound/[slug]/analysis.md` if writing is appropriate.
