...
# /muzekkere-triyaji (Müzekkere Triyajı)
...
3. Eğer ağır ceza/kapsamlı savcılık soruşturması ise → dur, `~/.claude/plugins/config/hukuki-yetenek-seti/dava-yonetimi/CLAUDE.md` uyarınca doğrudan ceza avukatına eskalasyon yap. Aksi takdirde devam et.
4. Çapraz kontrol için `~/.claude/plugins/config/hukuki-yetenek-seti/dava-yonetimi/matters/_log.yaml` dosyasını yükle. `~/.claude/plugins/config/hukuki-yetenek-seti/dava-yonetimi/CLAUDE.md` yükle → harita, gizlilik (ticari sır) kuralları, eskalasyon normları.
...
7. `~/.claude/plugins/config/hukuki-yetenek-seti/dava-yonetimi/inbound/[kisa-ad]/triage.md` dosyasına yaz. Müzekkereyi `~/.claude/plugins/config/hukuki-yetenek-seti/dava-yonetimi/inbound/[kisa-ad]/incoming.[uzanti]` olarak kopyala veya linkle.
...
- `~/.claude/plugins/config/hukuki-yetenek-seti/dava-yonetimi/matters/_log.yaml` — ilişkili dosya araması ve muhafaza durumu için
- `~/.claude/plugins/config/hukuki-yetenek-seti/dava-yonetimi/CLAUDE.md` → harita (düzenleyici kurumlar), kurum gizlilik kuralları, eskalasyon
...
Çıktı: `~/.claude/plugins/config/hukuki-yetenek-seti/dava-yonetimi/inbound/[kisa-ad]/triage.md`.
