...
1. Load `~/.claude/plugins/config/hukuki-yetenek-seti/dava-yonetimi/CLAUDE.md`.
...
4. Write `~/.claude/plugins/config/hukuki-yetenek-seti/dava-yonetimi/demand-letters/[slug]/intake.md`.
5. Confirm:

   > Hazırlık kaydedildi. Hazır olduğunuzda `/dava-yonetimi:ihtarname-hazirla [slug]` komutunu çalıştırın.
