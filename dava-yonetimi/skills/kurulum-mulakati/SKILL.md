...
Bu skill `dava-yonetimi` profilini Türk yargı sistemi ve Türk avukatlık pratiğine göre kurar. Var olan profil doluysa `--redo` olmadan üzerine yazmadan önce onay ister.
...
1. Check `~/.claude/plugins/config/hukuki-yetenek-seti/dava-yonetimi/CLAUDE.md`.
